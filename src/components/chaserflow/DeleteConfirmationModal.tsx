...
export const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({
  ...
  const remindersCount = invoice.remindersSentCount || 0;
      ...
      >
              ...
              <p className="text-[11px] leading-relaxed text-slate-600 dark:text-slate-400">
                ...
                {remindersCount > 0 && (
                  <span className="block mt-0.5 font-medium text-rose-700 dark:text-rose-400">
                    &bull; Note: {remindersCount} previous reminder notification{remindersCount === 1 ? '' : 's'} recorded for this invoice will be removed.
                  </span>
                )}
              </p>
            </div>
        ...
        <div className={`px-6 py-4 border-t flex flex-col-reverse sm:flex-row items-center justify-end gap-2.5 ${
          ...
          >
            ...
            <span>Delete Invoice Record</span>
          </button>
        </div>
      </div>
    </div>
